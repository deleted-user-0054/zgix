...
|--------|----------|-----------|-------------|
| Requests/sec (wrk median) | **103815.98** | **119360.00** | **1564.08** |
| Avg latency | **527.51us 317.47us** | **487.59us 391.27us** | **86.37ms 165.85ms** |
| RAM usage (under load) | **51.5 MB** | **3.2 MB** | **9.8 MB** |
<!-- BENCH:END -->
